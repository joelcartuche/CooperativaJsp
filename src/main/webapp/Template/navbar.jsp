...
<nav class="navbar navbar-expand-lg myBgNavbar">
    <div class="container-fluid">
        ...
        <!-- offcanvas trigger -->
        <!-- Navbar -->
        <a class="navbar-brand fw-bold text-uppercase me-auto myLogo" href="#">TAXOPEL</a>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end " aria-labelledby="navbarDropdown">
                        ...
                        -->
                        <li><a class="dropdown-item" href="<%=dom.getDominio()%>Configuraciones"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
    ...
    <div class="offcanvas-body p-0 hidenScroll">
        <nav class="navbar-light">
            <ul class="navbar-nav">
                ...
                <li class="offcanvasItems">
                    <a href="<%=dom.getDominio()%>Retiro?accion=buscarcuenta" class="nav-link px-3 active">
        ...
        <li class="offcanvasItems">
            <a href="#" class="nav-link px-3 active">
                    ...
                    <div class="collapse" id="collapsePartnerAccounts">
                        <div>
                            <ul class="navbar-nav ps-3">
                                <li>
                                    <a href="<%=dom.getDominio()%>CuentasCooperativa?accion=buscarCuenta" class="nav-link px-3">
                                        <span class="me-2">
                                ...
                                <li>
                                    <a href="<%=dom.getDominio()%>CuentasCooperativa?accion=listar" class="nav-link px-3">
                                        <span class="me-2">
                    ...
                    <div class="collapse" id="collapsePartners">
                        <div>
                            <ul class="navbar-nav ps-3">
                                ...
                                <li>
                                    <a href="<%=dom.getDominio()%>Socio?accion=agregar" class="nav-link px-3">
                                        <span class="me-2">
                ...
                <li class="offcanvasItems">
                    <a href="<%=dom.getDominio()%>Reportes/listarReporte.jsp" class="nav-link px-3 active">
                ...
                <li class="offcanvasItems">
                    <a href="<%=dom.getDominio()%>Configuraciones" class="nav-link px-3 active">
                        <span class="myIconText me-2">
                            <i class="bi bi-gear"></i>
                        </span>
                        <span class="myOffCanvaSubtitle">Configuración</span>
                    </a>
                </li>
