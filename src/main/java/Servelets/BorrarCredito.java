...
@WebServlet(name = "BorrarCredito", urlPatterns = {"/BorrarCredito"})
public class BorrarCredito extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<TasaAmortizacion> tasaList = tasaAmortizacionJpaController.findTasaAmortizacionIdCredito(credito);
            if (!tasaList.isEmpty()) {
                for (TasaAmortizacion tasaAmortizacion : tasaList) {
